...
Production config is **locked**: prompt ``v3``, model ``deepseek/deepseek-v4-flash``, abstention enabled.

Threshold (decision block in ``04_pipeline_eval.ipynb`` §6): the 0.75
...
headline analysis and the threshold ±0.05 sensitivity can
...
# Locked production config + threshold.
PROMPT_VERSION = "v3"
THRESHOLD = 0.75
