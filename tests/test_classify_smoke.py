...
def test_classify_live_smoke():
    ...
    (themes + entities + URL) as the classifier input — this is a smoke
    stand-in, not a commitment to the production text_snippet definition (a
    cleaning-stage decision).
    """
    from elections_frames.classify import FrameClassification, classify_article
