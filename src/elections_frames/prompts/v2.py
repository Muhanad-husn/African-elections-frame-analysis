...
Session-4 schema could not express an empty label at all. But 135/250 eval rows
...
really about the election. This pairs with the Session-5 schema relaxation
...
Iteration rule (IMPLEMENTATION_PLAN.md Session 5): each version is its own file
