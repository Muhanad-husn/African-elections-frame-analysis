...
summary tables that fit naturally into a notebook decision block. Project-
specific diagnostics (e.g. frame-label boundary cases) live alongside the
...
def distribution_compare(
    ...
    """Compare distributions side-by-side (before/after, across groups, ...)."""
    rows = []
...
def compare_alternatives(
    ...
    Classic sensitivity-check helper: feed it the data and a dict of candidate
    processing functions (e.g. different relevance-filter rules), and get back
    a side-by-side summary of what each produces.
    """
